...
globals [log_changes mean_wealth old_mean_wealth
  mean_wealth_stop_tick mean_wealth_past_tick_1 mean_wealth_past_tick_2 mean_wealth_past_tick_3
  share_top10_stop_tick share_top10_past_tick_1 share_top10_past_tick_2 share_top10_past_tick_3
  share_top1_stop_tick share_top1_past_tick_1 share_top1_past_tick_2 share_top1_past_tick_3
  share_top01_stop_tick share_top01_past_tick_1 share_top01_past_tick_2 share_top01_past_tick_3
  gini_stop_tick gini_past_tick_1 gini_past_tick_2 gini_past_tick_3
  tailexp_top10_stop_tick tailexp_top10_past_tick_1 tailexp_top10_past_tick_2 tailexp_top10_past_tick_3
  tailexp_top5_stop_tick tailexp_top5_past_tick_1 tailexp_top5_past_tick_2 tailexp_top5_past_tick_3
  tailexp_top1_stop_tick tailexp_top1_past_tick_1 tailexp_top1_past_tick_2 tailexp_top1_past_tick_3
  ...
  stillintop01_past_tick_1 stillintop01_past_tick_2 stillintop01_past_tick_3
  growth_rate_all growth_rate_past_tick_1 growth_rate_past_tick_2  growth_rate_past_tick_3
]
turtles-own [wealth wealth_return tax rank
  ...
  intop01_past_tick_1 intop01_past_tick_2 intop01_past_tick_3 intop01_stop_tick
]
...
to go
  ...
  set mean_wealth mean [wealth] of turtles
  ...
  if (ticks = stop_tick - past_tick_1) [
    ...
    ask turtles [
      ...
      set intop01_past_tick_1 wealth > quantile_top01
    ]
    set share_top10_past_tick_1 (sum [wealth] of turtles with [wealth > quantile_top10]) / (mean_wealth_past_tick_1 * count turtles)
    set share_top1_past_tick_1 (sum [wealth] of turtles with [wealth > quantile_top1]) / (mean_wealth_past_tick_1 * count turtles)
    if (any? turtles with [wealth > quantile_top01]) [ set share_top01_past_tick_1 (sum [wealth] of turtles with [wealth > quantile_top01]) / (mean_wealth_past_tick_1 * count turtles)]
    set gini_past_tick_1 gini [wealth] of turtles
    set tailexp_top10_past_tick_1 tail-exponent-fit ([wealth] of turtles with [wealth > quantile_top10]) quantile_top10
    set  tailexp_top5_past_tick_1 tail-exponent-fit ([wealth] of turtles with [wealth > quantile_top5]) quantile_top5
    set  tailexp_top1_past_tick_1 tail-exponent-fit ([wealth] of turtles with [wealth > quantile_top1]) quantile_top1
  ]
  ...
  if (ticks = stop_tick - past_tick_2) [
    ...
    ask turtles [
      ...
      set intop01_past_tick_2 wealth > quantile_top01
    ]
    set share_top10_past_tick_2 (sum [wealth] of turtles with [wealth > quantile_top10]) / (mean_wealth_past_tick_2 * count turtles)
    set share_top1_past_tick_2 (sum [wealth] of turtles with [wealth > quantile_top1]) / (mean_wealth_past_tick_2 * count turtles)
    if (any? turtles with [wealth > quantile_top01]) [ set share_top01_past_tick_2 (sum [wealth] of turtles with [wealth > quantile_top01]) / (mean_wealth_past_tick_2 * count turtles)]
    set gini_past_tick_2 gini [wealth] of turtles
    set tailexp_top10_past_tick_2 tail-exponent-fit ([wealth] of turtles with [wealth > quantile_top10]) quantile_top10
    set  tailexp_top5_past_tick_2 tail-exponent-fit ([wealth] of turtles with [wealth > quantile_top5]) quantile_top5
    set  tailexp_top1_past_tick_2 tail-exponent-fit ([wealth] of turtles with [wealth > quantile_top1]) quantile_top1
  ]
  ...
  if (ticks = stop_tick - past_tick_3) [
    ...
    ask turtles [
      ...
      set intop01_past_tick_3 wealth > quantile_top01
    ]
    set share_top10_past_tick_3 (sum [wealth] of turtles with [wealth > quantile_top10]) / (mean_wealth_past_tick_3 * count turtles)
    set share_top1_past_tick_3 (sum [wealth] of turtles with [wealth > quantile_top1]) / (mean_wealth_past_tick_3 * count turtles)
    if (any? turtles with [wealth > quantile_top01]) [ set share_top01_past_tick_3 (sum [wealth] of turtles with [wealth > quantile_top01]) / (mean_wealth_past_tick_3 * count turtles)]
    set gini_past_tick_3 gini [wealth] of turtles
    set tailexp_top10_past_tick_3 tail-exponent-fit ([wealth] of turtles with [wealth > quantile_top10]) quantile_top10
    set  tailexp_top5_past_tick_3 tail-exponent-fit ([wealth] of turtles with [wealth > quantile_top5]) quantile_top5
    set  tailexp_top1_past_tick_3 tail-exponent-fit ([wealth] of turtles with [wealth > quantile_top1]) quantile_top1
  ]
  tick
  if (ticks = stop_tick) [
    ; stop tick measures
    ...
    ask turtles [
      ...
      set intop01_stop_tick wealth > quantile_top01
    ]
    ...
    set stillintop01_past_tick_1 count turtles with [intop01_past_tick_1 and intop01_stop_tick] / count turtles with [intop01_stop_tick]
    ...
    set stillintop01_past_tick_2 count turtles with [intop01_past_tick_2 and intop01_stop_tick] / count turtles with [intop01_stop_tick]
    ...
    set stillintop01_past_tick_3 count turtles with [intop01_past_tick_3 and intop01_stop_tick] / count turtles with [intop01_stop_tick]
...
<experiments>
  <experiment name="experiment tax wealth" repetitions="100" runMetricsEveryStep="false">
    ...
    <metric>alreadyintop10_past_tick_1</metric>
    <metric>alreadyintop10_past_tick_2</metric>
    <metric>alreadyintop10_past_tick_3</metric>
    <metric>alreadyintop1_past_tick_1</metric>
    <metric>alreadyintop1_past_tick_2</metric>
    <metric>alreadyintop1_past_tick_3</metric>
    <metric>alreadyintop01_past_tick_1</metric>
    <metric>alreadyintop01_past_tick_2</metric>
    <metric>alreadyintop01_past_tick_3</metric>
  ...
  <experiment name="experiment tax wealth N 2,5,20,50 -.000" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean_wealth_stop_tick</metric>
    <metric>mean_wealth_past_tick_1</metric>
  ...
  <experiment name="experiment tax wealth gains N 2,5,20,50 -.000" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean_wealth_stop_tick</metric>
    <metric>mean_wealth_past_tick_1</metric>
  ...
  <experiment name="experiment tax wealth N 100K" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean_wealth_stop_tick</metric>
    <metric>mean_wealth_past_tick_1</metric>
  ...
  <experiment name="experiment tax wealth gains N 100K" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean_wealth_stop_tick</metric>
    <metric>mean_wealth_past_tick_1</metric>
